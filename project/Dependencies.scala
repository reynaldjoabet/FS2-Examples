...
object Dependencies {
  ...
  private object Http {
    ...
    private val http4sArtifacts =
      List("dsl", "ember-server", "ember-client", "circe")
  ...
  val allDependencies     =
    Kafka.deps ++ Cats.deps ++ Http.deps ++ Json.deps ++ Misc.deps
